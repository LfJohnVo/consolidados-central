                ...
                <div class="wrapper">
                    ...
                    <header class="main-header" style="background-color: black;">
                        ...
                        <nav class="navbar navbar-static-top" role="navigation" style="background-color: black;">
                            ...
                            <a href="#" style="color: white;" class="sidebar-toggle" data-toggle="push-menu"
                                role="button">
                    ...
                    <footer class="main-footer" style="max-height: 100px;text-align: center">
                        <strong>Creado por: © {{ date('Y') }} <a href="http://integrador-technology.mx"
                                target="_blank">Operadora Central de Estacionamientos</a>.</strong> All rights reserved.
                    </footer>
